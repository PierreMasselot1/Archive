...
void GcodeSuite::G28() {
  ...
  endstops.enable(true); // Enable endstops for next homing move
    ...
    const bool homeX = parser.seen('X'), homeY = parser.seen('Y'), homeZ = parser.seen('Z'), homeI = parser.seen('I'),
               home_all = homeX == homeY && homeX == homeZ, // All or None
               doX = home_all || homeX, doY = home_all || homeY, doZ = home_all || homeZ, doI = home_all || homeI;
